...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝑺𝒐𝒎𝒆𝒓𝒂-𝑩𝒐𝒕' + gt + ' 𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿', '𝑺𝒐𝒎𝒆𝒓𝒂'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
